...
exports.onCompetitionStatusChange = exports.onSubmissionCreated = exports.sendTeamInviteEmail = exports.scoreSubmissionHttp = exports.scoreSubmissionFunction = exports.createUserRole = void 0;
...
exports.scoreSubmissionHttp = functions.https.onRequest(async (req, res) => {
    // Apply CORS
    corsHandler(req, res, async () => {
        ...
        try {
            ...
            return res.status(500).json({ success: false, error: (err === null || err === void 0 ? void 0 : err.message) || "Unknown error" });
        }
    });
});
...
exports.sendTeamInviteEmail = (0, firestore_1.onDocumentCreated)("team_invites/{inviteId}", async (event) => {
    ...
    if (!invite)
        return logger.error("No invite data found");
    const resendApiKey = process.env.RESEND_API_KEY;
    if (!resendApiKey)
        return logger.warn("RESEND_API_KEY not configured, skipping email");
    try {
